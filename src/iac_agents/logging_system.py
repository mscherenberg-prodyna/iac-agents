...
class AgentLogger:
    ...
    def log_agent_start(self, agent_name: str, activity: str, details: Dict[str, Any] = None):
    ...
    def log_agent_complete(self, agent_name: str, activity: str, details: Dict[str, Any] = None):
        ...
        details_str = f" | {details}" if details else ""
        self.logger.info(f"✅ {agent_name} COMPLETED: {activity}{duration_str}{details_str}")
    ...
    def log_warning(self, agent_name: str, message: str, details: Dict[str, Any] = None):
        """Log warnings."""
        entry = AgentLogEntry(
            timestamp=datetime.now(),
            agent_name=agent_name,
    ...
    def get_logs_for_agent(self, agent_name: str, limit: int = 10) -> List[AgentLogEntry]:
