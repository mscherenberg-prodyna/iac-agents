...
class TerraformDeploymentManager:
    ...
    def create_deployment_workspace(self, deployment_id: str, template: str, 
...
'''
    ...
    def plan_deployment(self, deployment_id: str, template: str, 
                       variables: Dict[str, str] = None) -> DeploymentStatus:
        """Plan a Terraform deployment."""
        workspace_dir = self.create_deployment_workspace(deployment_id, template, variables)
    ...
    def apply_deployment(self, deployment_id: str, auto_approve: bool = False) -> DeploymentStatus:
    ...
    def destroy_deployment(self, deployment_id: str, auto_approve: bool = False) -> DeploymentStatus:
    ...
    def _run_terraform_command(self, workspace_dir: str, args: List[str], 
                             deployment_status: DeploymentStatus) -> str:
...
"""
        ...
        if status.completed_at:
            ...
            summary += f"**Completed**: {status.completed_at.strftime('%Y-%m-%d %H:%M:%S')}\n"
