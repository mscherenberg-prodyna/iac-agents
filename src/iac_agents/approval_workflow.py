...
"""
    ...
    def _approve_request(self, request: ApprovalRequest, reviewer: str, notes: Optional[str]) -> str:
...
"""
    ...
    def _reject_request(self, request: ApprovalRequest, reviewer: str, notes: Optional[str]) -> str:
...
"""
    ...
    def _request_changes(self, request: ApprovalRequest, reviewer: str, notes: Optional[str]) -> str:
...
"""
    ...
    def get_approval_history(self, limit: int = 10) -> List[ApprovalRequest]:
        ...
        return sorted(self.approval_history, key=lambda x: x.created_at, reverse=True)[:limit]
