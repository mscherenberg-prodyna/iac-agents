...
def main():
    ...
    main_cmd = [sys.executable, "-m", "streamlit", "run", str(streamlit_dir / "gui.py"), "--server.port", "8501"]
    log_cmd = [sys.executable, "-m", "streamlit", "run", str(streamlit_dir / "log_viewer_app.py"), "--server.port", "8502"]
