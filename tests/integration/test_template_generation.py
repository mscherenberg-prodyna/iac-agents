...
def test_document_storage_request():
    ...
    request = ("I have a number of documents that I need to keep for legal reasons. "
    ...
    assert "terraform" in template.lower(), "Template should contain terraform configuration"
...
def test_web_application_request():
    ...
    request = "I need to deploy a secure web application with auto-scaling and monitoring."
    ...
    assert "terraform" in template.lower(), "Template should contain terraform configuration"
    assert "resource" in template.lower(), "Template should contain resource definitions"
...
def test_compliance_validation():
    ...
    assert response, "Response should not be empty"
    assert "compliance" in response.lower() or "validation" in response.lower(), \
