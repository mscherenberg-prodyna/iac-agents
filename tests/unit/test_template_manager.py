...
def test_get_fallback_template_storage():
    ...
    for request in storage_requests:
        ...
        assert (
            "storage" in template_lower or "azurerm_storage_account" in template_lower
        )
...
def test_get_fallback_template_compute():
    ...
    for request in compute_requests:
        ...
        assert any(
            ...
            for keyword in ["vm", "virtual", "compute", "machine"]
        )
...
def test_template_validation():
    ...
    requests = ["Storage account", "Web application", "Database setup"]
